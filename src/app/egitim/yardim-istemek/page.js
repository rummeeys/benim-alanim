...
const SAMPLE_VIDEO_SRC = "/videos/level-3.mp4";

export default function YardimIstemekEgitimPage() {
  ...
  useEffect(() => {
    router.prefetch("/oyun/kahramanlik-oyunu");
  }, [router]);
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 py-4 md:px-8 md:py-8">
          <div className="w-full max-w-4xl">
            <p className="mb-4 text-center text-lg font-bold text-sky-800 md:text-xl">
              Yardım İstemek Kahramanlıktır — Eğitim Videosu
            </p>
